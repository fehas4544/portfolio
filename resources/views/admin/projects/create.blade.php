...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-bold text-slate-800 tracking-tight">Add New Project</h1>
    <p class="text-slate-500 font-medium">Create a new entry for your portfolio gallery</p>
</div>
    ...
    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                ...
                <select name="category" required 
                    ...
                    <option value="management">Management Project</option>
                </select>
            </div>
        </div>
        ...
        <div class="space-y-2">
            ...
            <textarea name="description" rows="4" required
                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none"
                placeholder="Detailed project overview...">{{ old('description') }}</textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div class="flex items-center space-x-3 pt-6">
                ...
                <input type="checkbox" name="is_featured" value="1" id="is_featured" class="w-5 h-5 text-blue-600 rounded-lg border-slate-300 focus:ring-blue-500">
